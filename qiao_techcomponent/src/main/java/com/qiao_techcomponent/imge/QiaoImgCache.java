...
import com.qiao_techcomponent.BuildConfig;
 ...
 * 管理内存中的图片
 */
public class QiaoImgCache {

    private static QiaoImgCache instance;
    ...
    public static QiaoImgCache getInstance(){
        if(null==instance){
            synchronized (QiaoImgCache.class){
                if(null==instance){
                    instance=new QiaoImgCache();
                }
            }
        }
        return instance;
     ...
     * 加入磁盘缓存
     */
    public void putBitmapToDisk(String key,Bitmap bitmap,int quality){
